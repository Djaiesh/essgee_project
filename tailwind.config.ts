  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        'micro': ['0.875rem', { lineHeight: '1.5', letterSpacing: '0.05em' }],
      },
      colors: {
        ...
        'fiery-glow': "hsl(var(--fiery-glow))",
        'pumpkin-vapor': "hsl(var(--pumpkin-vapor))",
        'venetian-lace': "hsl(var(--venetian-lace))",
        'macadamia-beige': "hsl(var(--macadamia-beige))",
        primary: {
